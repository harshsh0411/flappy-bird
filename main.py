...
# background
BACKGROUND_IMAGE = pygame.image.load('c:/python39/gallery/background.jpg')

#  BIRD
BIRD_IMAGE = pygame.image.load('c:/python39/gallery/bird1.png')
bird_x = 50
bird_y = 200
bird_y_change = 0
...
def display_obstacle(height):
    ...
    pygame.draw.rect(SCREEN, OBSTACLE_COLOR, (obstacle_x, 735, OBSTACLE_WIDTH, -bottom_obstacle_height))
